...
public class ge {
    public void regist1(String uname,String pd,String pd_,String email,String cname,String sex,String date_ )throws
        ...
        try {
            System.setProperty("webdriver.firefox.bin","C:\\Program Files\\Mozilla Firefox\\geckodriver.exe");
    ...
    public static void test05() throws ClassNotFoundException, SQLException, InterruptedException {
